...
import "../../styles/errorPage/page.scss";
...
const page = (props: Props) => {
        ...
        <div className="container">
          ...
          <div className="right-section">
            ...
            S149.306,67.362,149.306,71.528z"
                ...
                >
                  <stop offset="0%" style={{ color: "#FFFFFF", opacity: 1 }} />
                  <stop offset="50%" style={{ color: "#EDEDED", opacity: 0.5 }}>
                    <animate
  ...
  if (!statusCode || !errorMessage) {
    ...
    return renderItem(statusCode, errorMessage);
  }
};
